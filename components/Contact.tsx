...
export default function Contact() {
  const contactInfo = [
    {
      type: "Email",
      value: "udit55sharma@gmail.com",
      link: "mailto:udit55sharma@gmail.com",
      icon: (
    ...
    {
      type: "LinkedIn",
      value: "linkedin.com/in/udit55sharma",
      link: "https://linkedin.com/in/udit55sharma",
      icon: (
    ...
    {
      type: "GitHub",
      value: "github.com/Udit55Sharma",
      link: "https://github.com/Udit55Sharma",
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
